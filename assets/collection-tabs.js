...
document.addEventListener('DOMContentLoaded', function() {
  var viewport = document.querySelector('#product-grid-template--17312678248609__collection_tabs_hgd4U9 .flickity-viewport');
     console.log('获取到节点',viewport);
  if (viewport) {
    viewport.style.setProperty('height', '400px', 'important');
  }
});
